...
def table_of_contents(self):
    ...
    try:
        with open(self.project_directory + "/SUMMARY.md", "r") as summary:
            for line in summary:
...
def new_section_after(self, widget, model, path):
    ...
    it = self.toc_model.insert_after(parent, sibling, (text1, '{}/{}.md'.format(dir, text2), 0, 0, 0, 0, 0, 0))

    # get the full (absolute) filepath and filename
    filepath = '{}/{}/{}.md'.format(self.project_directory, dir, text2)
